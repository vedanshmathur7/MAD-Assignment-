...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private TextView accXTextView, accYTextView, accZTextView, lightTextView, proximityTextView, statusTextView;
    ...
    private void checkSensorAvailability() {
        ...
        if (accelerometer == null) statusMessage.append("No Accelerometer.\n");
        if (lightSensor == null) statusMessage.append("No Light Sensor.\n");
        if (proximitySensor == null) statusMessage.append("No Proximity Sensor.\n");

        statusTextView.setText(statusMessage.length() == 0 ? "All sensors available." : statusMessage.toString());
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        // Update UI when sensor values change
